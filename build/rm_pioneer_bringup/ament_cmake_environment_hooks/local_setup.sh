...
: ${AMENT_CURRENT_PREFIX:="/root/config/rm_pioneer_config/install/rm_pioneer_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm_pioneer_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm_pioneer_bringup/environment/path.sh"
